...
- (BOOL) hasForensicCheckFieldWithName:(NSString *)name {
  return ptr->HasForensicCheckField([name UTF8String])? YES : NO;
}

- (SEDocForensicCheckFieldRef *) getForensicCheckFieldWithName:(NSString *)name {
  try {
    return [[SEDocForensicCheckFieldRef alloc]
        initFromInternalForensicCheckFieldPointer:const_cast<se::doc::DocForensicCheckField*>(&ptr->GetForensicCheckField([name UTF8String]))
                       withMutabilityFlag:NO];
  } catch (const se::common::BaseException& e) {
    throwFromException(e);
  }
...
- (SEDocForensicCheckFieldRef *) getMutableForensicCheckFieldWithName:(NSString *)name {
  if (!is_mutable) {
    throwNonMutableRefException();
  } else {
    try {
      return [[SEDocForensicCheckFieldRef alloc]
          initFromInternalForensicCheckFieldPointer:&ptr->GetMutableForensicCheckField([name UTF8String])
                         withMutabilityFlag:YES];
    } catch (const se::common::BaseException& e) {
      throwFromException(e);
    }
...
- (void) removeForensicCheckFieldWithName:(NSString *)name {
  if (!is_mutable) {
    throwNonMutableRefException();
  } else {
    try {
      ptr->RemoveForensicCheckField([name UTF8String]);
    } catch (const se::common::BaseException& e) {
      throwFromException(e);
    }
  }
...
- (SEDocForensicCheckFieldsIterator *) forensicCheckFieldsBegin {
  return [[SEDocForensicCheckFieldsIterator alloc]
      initFromInternalForensicCheckFieldsIterator:ptr->ForensicCheckFieldsBegin()];
}

- (SEDocForensicCheckFieldsIterator *) forensicCheckFieldsEnd {
  return [[SEDocForensicCheckFieldsIterator alloc]
      initFromInternalForensicCheckFieldsIterator:ptr->ForensicCheckFieldsEnd()];
}
...
- (NSString *) getType {
  return [NSString stringWithUTF8String:ptr->GetType()];
}
