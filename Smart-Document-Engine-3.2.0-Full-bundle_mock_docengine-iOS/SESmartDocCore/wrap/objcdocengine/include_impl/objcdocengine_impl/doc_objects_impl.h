...
@interface SEDocTextLineObjectRef (Internal)

- (instancetype) initFromInternalTextLineObjectPointer:(se::doc::DocTextLineObject *)objptr
                                withMutabilityFlag:(BOOL)mutabilityFlag;
- (se::doc::DocTextLineObject *) getInternalTextLineObjectPointer;
...
@interface SEDocForensicCheckObjectRef (Internal)

- (instancetype) initFromInternalForensicCheckObjectPointer:(se::doc::DocForensicCheckObject *)objptr
                                withMutabilityFlag:(BOOL)mutabilityFlag;
- (se::doc::DocForensicCheckObject *) getInternalForensicCheckObjectPointer;
