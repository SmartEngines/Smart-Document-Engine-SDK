 ...
 */
class SE_DLL_EXPORT DocTextLineObject : public DocBasicObject {
public:
  /// Default dtor
...
/**
 * @brief The graphical object representing a text
 */
...
/**
 * @brief The graphical object representing a forensic check
 */
