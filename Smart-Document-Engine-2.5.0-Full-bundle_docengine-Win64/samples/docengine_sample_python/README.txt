...
#
# HOWTO:
#   1. Run build_python.py script from its local directory with one parameter 'Win32' (Win64 default) 
...
#     wrapper.
#     Keep in mind that the built _pydocengine.pyd Python module should be placed 
#     in the same directory with docengine.dll, path to this directory should be explicitly 
