...
public class DocResult {
  ...
  public DocResult Clone() {
    long cPtr = jnidocengineJNI.DocResult_Clone(swigCPtr, this);
    return (cPtr == 0) ? null : new DocResult(cPtr, false);
  }
  ...
  public DocSceneInfo GetSceneInfoPtr(int idx) {
    long cPtr = jnidocengineJNI.DocResult_GetSceneInfoPtr(swigCPtr, this, idx);
    return (cPtr == 0) ? null : new DocSceneInfo(cPtr, false);
  }

  public DocSceneInfo GetLastSceneInfoPtr() {
    long cPtr = jnidocengineJNI.DocResult_GetLastSceneInfoPtr(swigCPtr, this);
    return (cPtr == 0) ? null : new DocSceneInfo(cPtr, false);
  }
