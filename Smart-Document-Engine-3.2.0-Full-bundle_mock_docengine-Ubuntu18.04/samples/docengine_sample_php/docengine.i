...
// #include "docengine/doc_suite.h"
// #include "docengine/doc_suite_settings.h"
...
// %apply(char* ) { unsigned char*  config_data};
// %apply(char* ) { const char*  config_path};
...
%apply (char *STRING, size_t LENGTH) {(unsigned char* output_buf, unsigned long long buf_size)};
