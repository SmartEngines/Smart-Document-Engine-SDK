...
public class DocTableField : global::System.IDisposable {
  ...
  public virtual bool HasColumnIndexByName(string col_name) {
    bool ret = csdocenginePINVOKE.DocTableField_HasColumnIndexByName(swigCPtr, col_name);
    if (csdocenginePINVOKE.SWIGPendingException.Pending) throw csdocenginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual int GetColumnIndexByName(string col_name) {
    int ret = csdocenginePINVOKE.DocTableField_GetColumnIndexByName(swigCPtr, col_name);
    if (csdocenginePINVOKE.SWIGPendingException.Pending) throw csdocenginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
