...
public class DocPhysicalPage : global::System.IDisposable {
  ...
  public virtual DocPageInfo GetPageInfo() {
    DocPageInfo ret = new DocPageInfo(csdocenginePINVOKE.DocPhysicalPage_GetPageInfo(swigCPtr), false);
    if (csdocenginePINVOKE.SWIGPendingException.Pending) throw csdocenginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual DocPageInfo GetPageInfoPtr() {
    global::System.IntPtr cPtr = csdocenginePINVOKE.DocPhysicalPage_GetPageInfoPtr(swigCPtr);
    DocPageInfo ret = (cPtr == global::System.IntPtr.Zero) ? null : new DocPageInfo(cPtr, false);
    if (csdocenginePINVOKE.SWIGPendingException.Pending) throw csdocenginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public virtual Quadrangle GetPageQuadranglePtr() {
    global::System.IntPtr cPtr = csdocenginePINVOKE.DocPhysicalPage_GetPageQuadranglePtr(swigCPtr);
    Quadrangle ret = (cPtr == global::System.IntPtr.Zero) ? null : new Quadrangle(cPtr, false);
    if (csdocenginePINVOKE.SWIGPendingException.Pending) throw csdocenginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual Polygon GetPagePolygonPtr() {
    global::System.IntPtr cPtr = csdocenginePINVOKE.DocPhysicalPage_GetPagePolygonPtr(swigCPtr);
  ...
  public virtual DocTextObjectsIterator RawTextObjectsBegin() {
    DocTextObjectsIterator ret = new DocTextObjectsIterator(csdocenginePINVOKE.DocPhysicalPage_RawTextObjectsBegin(swigCPtr), true);
    if (csdocenginePINVOKE.SWIGPendingException.Pending) throw csdocenginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual DocTextObjectsIterator RawTextObjectsEnd() {
    DocTextObjectsIterator ret = new DocTextObjectsIterator(csdocenginePINVOKE.DocPhysicalPage_RawTextObjectsEnd(swigCPtr), true);
    if (csdocenginePINVOKE.SWIGPendingException.Pending) throw csdocenginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual int GetRawTextObjectsCount() {
    int ret = csdocenginePINVOKE.DocPhysicalPage_GetRawTextObjectsCount(swigCPtr);
    if (csdocenginePINVOKE.SWIGPendingException.Pending) throw csdocenginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual bool HasRawTextObject(string name) {
    bool ret = csdocenginePINVOKE.DocPhysicalPage_HasRawTextObject(swigCPtr, name);
    if (csdocenginePINVOKE.SWIGPendingException.Pending) throw csdocenginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public virtual DocTextObject GetRawTextObject(string name) {
    DocTextObject ret = new DocTextObject(csdocenginePINVOKE.DocPhysicalPage_GetRawTextObject(swigCPtr, name), false);
    if (csdocenginePINVOKE.SWIGPendingException.Pending) throw csdocenginePINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
