...
@implementation SEDocForensicCheckObjectRef {
  se::doc::DocForensicCheckObject* ptr;
  bool is_mutable;
}

+ (NSString *) objectTypeStatic {
  return [NSString stringWithUTF8String:se::doc::DocForensicCheckObject::ObjectTypeStatic()];
}
