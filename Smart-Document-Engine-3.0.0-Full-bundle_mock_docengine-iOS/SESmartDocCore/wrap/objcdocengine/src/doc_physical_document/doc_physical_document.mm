...
- (nonnull SEDocTableObjectsIterator *)forensicObjectsBegin:(nonnull NSString *)name {
  return [[SEDocTableObjectsIterator alloc]
          initFromInternalTableObjectsIterator:ptr->TableObjectsBegin([name UTF8String])];
}

- (nonnull SEDocTableObjectsIterator *)forensicObjectsEnd:(nonnull NSString *)name {
  return [[SEDocTableObjectsIterator alloc]
          initFromInternalTableObjectsIterator:ptr->TableObjectsEnd([name UTF8String])];
}

- (nonnull SEDocTableObjectsIterator *)forensicCheckObjectsBegin:(nonnull NSString *)name {
  return [[SEDocTableObjectsIterator alloc]
          initFromInternalTableObjectsIterator:ptr->TableObjectsBegin([name UTF8String])];
}

- (nonnull SEDocTableObjectsIterator *)forensicCheckObjectsEnd:(nonnull NSString *)name {
  return [[SEDocTableObjectsIterator alloc]
          initFromInternalTableObjectsIterator:ptr->TableObjectsEnd([name UTF8String])];
}
